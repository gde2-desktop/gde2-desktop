/*
 * gde2-color.c: GDE2 color selection tool
 *
...
#include <libgde2-desktop/gde2-colorseldialog.h>
#include <libgde2-desktop/gde2-colorsel.h>
...
copy_color (GtkWidget *widget, GdkEvent  *event, MateColorSelectionDialog *color_dialog)
{
    ...
    gde2_color_selection_get_current_color (GDE2_COLOR_SELECTION (color_dialog->colorsel), &color);
...
main (int argc, char **argv)
{
    ...
    color_dialog = gde2_color_selection_dialog_new (_("GDE2 Color Selection"));
    color_selection = GDE2_COLOR_SELECTION_DIALOG (color_dialog)->colorsel;
    gde2_color_selection_set_has_palette (GDE2_COLOR_SELECTION (color_selection), TRUE);
    ...
    gtk_widget_hide (GDE2_COLOR_SELECTION_DIALOG (color_dialog)->ok_button);
    gtk_widget_hide (GDE2_COLOR_SELECTION_DIALOG (color_dialog)->cancel_button);
    gtk_widget_hide (GDE2_COLOR_SELECTION_DIALOG (color_dialog)->help_button);
