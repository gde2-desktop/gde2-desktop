...
G_DEFINE_TYPE (MateRROutputInfo, gde2_rr_output_info, G_TYPE_OBJECT)

static void
gde2_rr_output_info_init (MateRROutputInfo *self)
{
    self->priv = G_TYPE_INSTANCE_GET_PRIVATE (self, GDE2_TYPE_RR_OUTPUT_INFO, MateRROutputInfoPrivate);
...
{
    MateRROutputInfo *self = GDE2_RR_OUTPUT_INFO (gobject);
...
static void
gde2_rr_output_info_class_init (MateRROutputInfoClass *klass)
{
