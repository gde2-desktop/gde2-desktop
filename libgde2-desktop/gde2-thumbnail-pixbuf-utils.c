/*
 * gde2-thumbnail-pixbuf-utils.c: Utilities for handling pixbufs when thumbnailing
 *
...
/**
 * gde2_desktop_thumbnail_scale_down_pixbuf:
 * @pixbuf: a #GdkPixbuf
 ...
 **/
GdkPixbuf *
gde2_desktop_thumbnail_scale_down_pixbuf (GdkPixbuf *pixbuf,
					   int dest_width,
					   int dest_height)
{
