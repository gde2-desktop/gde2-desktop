/*
 * gde2-dconf.c: helper API for dconf
 *
...
static DConfClient *
gde2_dconf_client_get (void)
{
    return dconf_client_new ();
}

/**
 * gde2_dconf_write_sync:
 ...
 */
gboolean
gde2_dconf_write_sync (const gchar  *key,
                       GVariant     *value,
                       GError      **error)
{
    gboolean     ret;
    DConfClient *client = gde2_dconf_client_get ();
 ...
 */
gboolean
gde2_dconf_recursive_reset (const gchar  *dir,
                            GError      **error)
{
    gboolean     ret;
    DConfClient *client = gde2_dconf_client_get ();
 ...
 */
gchar **
gde2_dconf_list_subdirs (const gchar *dir,
