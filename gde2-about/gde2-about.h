...
#ifndef __GDE2_ABOUT_H__
#define __GDE2_ABOUT_H__
...
const char* comments_array[] = {
    N_("GDE2 provides an intuitive and attractive desktop to Linux users "
    "using traditional metaphors."),

    N_("GDE2 includes most of what you see on your computer, including the file "
...
#else
    GApplication* gde2_about_application;
#endif

/**
 * If this value is set to TRUE, then gde2_about_dialog will not be called
 * on the main function.
 */
gboolean gde2_about_nogui = FALSE;
// functions
void gde2_about_run(void);
void gde2_about_release_version(void);
...
static GOptionEntry command_entries[] = {
    {"version", 'v', 0, G_OPTION_ARG_NONE, &gde2_about_nogui, "Show GDE2 version", NULL},
    {NULL}
};

#endif /* __GDE2_ABOUT_H__ */
